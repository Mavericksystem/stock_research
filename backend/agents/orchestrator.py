...
async def stream_agent(
    ...
    Emits tool call events in real time, then streams the final result.
    ...
    yield f"data: {json.dumps({'type': 'metadata', 'symbol': symbol})}\n\n"
    ...
    while tool_round < MAX_TOOL_ROUNDS:
        ...
        for tool_call in message.tool_calls:
            ...
            yield f"data: {json.dumps({'type': 'tool_call', 'tool': tool_name, 'status': 'calling'})}\n\n"
